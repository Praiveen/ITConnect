...
export function renderRegisterPage() {
  ...
  // Обработчики событий страницы регистрации
  ...
  document.querySelector('#register-form').addEventListener('submit', async (e) => {
    ...
    // Валидация пароля (согласно бэкенду минимум 5 символов)
    ...
    if (!terms) {
      errorElement.textContent = 'Необходимо согласиться с условиями использования'
      errorElement.style.display = 'block'
      return
    }
    ...
    try {
      ...
      successElement.textContent = result.message || 'Регистрация прошла успешно! Перенаправление на страницу входа...';
